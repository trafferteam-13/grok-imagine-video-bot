...
API_TOKEN = "8205771927:AAFTWuQf5dWVgy_mx6rWj3XxYJJe4T7953Q"
KIE_API_KEY = "0e2182764264e2a6ac25831e147345ed"
...
async def handle(message: types.Message):
    ...
    image_b64 = base64.b64encode(photo_bytes.read()).decode()
